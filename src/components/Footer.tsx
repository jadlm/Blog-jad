        ...
        <div className="py-12 md:py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-4">
              <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-primary to-primary-dark flex items-center justify-center text-white font-bold text-lg">
                A
              </div>
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-6">
              Practical advice on technology, web development, productivity, and online business. Helping developers and creators build better digital products.
            </p>
            {/* Social Links */}
        ...
        <div className="py-6 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex flex-col gap-1">
            <p className="text-sm text-muted-foreground">
              © {currentYear} AdviceHub. All rights reserved.
            </p>
            <p className="text-xs text-muted-foreground/60">
              Contact: <a href="mailto:lamtaifijad@outlook.fr" className="hover:text-primary transition-colors">lamtaifijad@outlook.fr</a>
            </p>
          </div>
          <p className="text-sm text-muted-foreground">
            Built with ❤️ for Jad Lamtaifi
          </p>
        </div>
      </div>
    </footer>
